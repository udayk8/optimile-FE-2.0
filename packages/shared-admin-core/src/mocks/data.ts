...
export const mockTenantVendors: TenantVendor[] = [
  {
    ...
    bankName: "HDFC Bank",
    branch: "Ghaziabad Main",
    accountNumber: "50100123456789",
    ifscCode: "HDFC0001234",
    accountType: "CURRENT",
    logoUrl:
      "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='120' height='48'><rect width='120' height='48' rx='6' fill='%232D3AC8'/><text x='60' y='30' font-family='Arial' font-size='18' font-weight='bold' fill='white' text-anchor='middle'>ABC</text></svg>",
    invoiceTerms: [
  ...
  },
  {
    ...
    bankName: "ICICI Bank",
    branch: "Hubballi",
    accountNumber: "002105500123",
    ifscCode: "ICIC0000021",
    accountType: "CURRENT",
    logoUrl:
      "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='120' height='48'><rect width='120' height='48' rx='6' fill='%232D3AC8'/><text x='60' y='30' font-family='Arial' font-size='16' font-weight='bold' fill='white' text-anchor='middle'>VRL</text></svg>",
    invoiceTerms: [
      "No credit is available unless confirmed in writing by our Authorised Signatory.",
      "Interest @ 18% per annum will be charged on delayed payments past the due date.",
      "Any discrepancies in the invoice should be informed in writing within 7 days of submission, otherwise the invoice will be considered as accepted.",
