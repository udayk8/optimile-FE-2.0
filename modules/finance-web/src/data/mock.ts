...
export const VENDOR_BILLS = [
  { id: "VB-8801", vendorId: "V-SHARMA", vendor: "Sharma Transport", trip: "TR-4401", lane: "Mumbai → Delhi", contractRate: 118000, billed: 118000, pod: true, status: "matched", terms: "Net 30", due: "2026-05-24", category: "Vehicle hire", commodity: "FMCG", commercialType: "SPOT" as const, rateCard: { source: "SPOT" as const, rateCardId: "CNT-AW-118", lane: "Mumbai → Delhi", rate: 118000, rateType: "PER_TRIP" as const, awarded: true, sourceAuctionId: "AUC-016", allocationRank: "L1" as const, volumeAllocationPercent: 100, validFrom: "2026-05-01", validTo: "2026-10-31" } },
  { id: "VB-8809", vendorId: "V-ROYAL", vendor: "Royal Carriers", trip: "TR-4441", lane: "Pune → Hyderabad", contractRate: 74000, billed: 84900, pod: true, status: "variance", variance: 14.7, terms: "Net 30", due: "2026-05-26", category: "Accessorial charges", commodity: "Chemicals", commercialType: "CONTRACT" as const, rateCard: { source: "CONTRACT" as const, rateCardId: "VRC-ROYAL-07", lane: "Pune → Hyderabad", vehicleType: "32ft SXL", rate: 74000, rateType: "PER_TRIP" as const, validFrom: "2026-01-01", validTo: "2026-12-31" } },
