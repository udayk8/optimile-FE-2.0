...
import { Home, Truck, Ship, MoreHorizontal, Search, FileText, User, X, Wallet, ShieldAlert, MessageSquareWarning } from 'lucide-react'
...
const MORE_NAV = [
  ...
  { path: '/vendor/disputes', label: 'Disputes', icon: MessageSquareWarning },
