        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-4">
          <div className="space-y-2">
            <label className="text-sm font-medium">
              Select Trip <span className="text-danger">*</span>
            </label>
            <select 
              className={`flex h-10 w-full rounded-lg border ${touched.tripId && errors.tripId ? 'border-danger' : 'border-gray-300'} bg-white px-3 py-2 text-sm  focus:outline-none focus:ring-2 focus:ring-primary/20 focus:ring-offset-2`}
              value={tripId}
            ...
            {touched.tripId && errors.tripId && (
              <p className="text-xs text-danger">{errors.tripId}</p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input 
              ...
              className={touched.amount && errors.amount ? 'border-danger focus-visible:ring-danger/20' : ''}
            />
