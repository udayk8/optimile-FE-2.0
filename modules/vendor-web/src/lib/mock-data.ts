...
export const MOCK_NOTIFICATIONS: Notification[] = [
  ...
  { id: 'n10', type: 'EXPENSES',   title: 'Expense Rejected',            message: 'Toll expense ₹850 for TRP-048 rejected. Missing receipt.',                          deepLink: '/vendor/expenses',                    isRead: false, createdAt: new Date(Date.now() - 24  * 3600 * 1000).toISOString() },
