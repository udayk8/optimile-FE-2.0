...
export const MOCK_TRIPS: Trip[] = [
  {
    id: 'TRP-044', contractId: 'CNT-001', indentId: 'IND-098', status: 'IN_TRANSIT_ON_TIME',
    laneDetails: { origin: { name: 'Mumbai Port', city: 'Mumbai', state: 'Maharashtra' }, destination: { name: 'Delhi NCR Hub', city: 'Delhi', state: 'Delhi' }, distanceKm: 1420 },
  ...
  {
    id: 'TRP-042', contractId: 'CNT-002', indentId: 'IND-096', status: 'IN_TRANSIT_ON_TIME',
  ...
  {
    id: 'TRP-045', contractId: 'CNT-002', indentId: 'IND-099', status: 'IN_TRANSIT_DELAYED',
    ...
    timeline: [
      { id: 'tt-7', title: 'Disruption reported', description: 'Driver breakdown at unloading point', timestamp: '2026-04-26T13:00:00Z', status: 'EXCEPTION' },
    ],
  ...
  },
  {
    ...
    deliveredDate: '2026-04-26T09:00:00Z', podStatus: 'CONFIRMED',
    documents: [
  ...
  {
    id: 'TRP-047', contractId: 'CNT-001', indentId: 'IND-101', status: 'DELIVERED',
    ...
    timeline: [
      { id: 'tt-9', title: 'Delivered', description: 'Delivered after reschedule and POD confirmed', timestamp: '2026-04-24T10:00:00Z', status: 'DELIVERED' },
    ],
  ...
  {
    id: 'TRP-048', contractId: 'CNT-002', indentId: 'IND-102', status: 'IN_TRANSIT_DELAYED',
    ...
    timeline: [
      { id: 'tt-10', title: 'Disrupted', description: 'Vehicle breakdown during transit', timestamp: '2026-04-27T12:00:00Z', status: 'EXCEPTION' },
    ],
    freightRate: 18000, expenseSummary: { total: 0, approved: 0, pending: 0 }, isInvoiced: false,
    createdAt: '2026-04-26T08:00:00Z',
  },
  {
    id: 'TRP-049', contractId: 'CNT-001', indentId: 'IND-103', status: 'IN_TRANSIT_ON_TIME',
    ...
    documents: [],
    timeline: [
      { id: 'tt-11', title: 'Disrupted', description: 'Vehicle and driver replacement requested', timestamp: '2026-04-28T07:30:00Z', status: 'EXCEPTION' },
    ],
    freightRate: 24000, expenseSummary: { total: 0, approved: 0, pending: 0 }, isInvoiced: false,
    createdAt: '2026-04-27T18:00:00Z',
  },
  {
    id: 'TRP-050', contractId: 'CNT-002', indentId: 'IND-104', status: 'DELIVERED',
    ...
    documents: [
      { id: 'td-14', type: 'REMARKS', title: 'Delivery note', fileName: 'delivery-note-trp-050.txt', fileUrl: '/docs/delivery-note-trp-050.txt', createdAt: '2026-05-17T18:00:00Z', note: 'Awaiting consignee POD upload' },
    ],
    timeline: [
      { id: 'tt-12', title: 'Delivered', description: 'Delivered; POD pending from destination team', timestamp: '2026-05-17T17:30:00Z', status: 'DELIVERED' },
    ],
    freightRate: 36000, expenseSummary: { total: 0, approved: 0, pending: 0 }, isInvoiced: false,
    createdAt: '2026-05-16T08:30:00Z',
  },
  {
    id: 'TRP-051', contractId: 'CNT-002', indentId: 'IND-105', status: 'CANCELLED',
    ...
    documents: [
      { id: 'td-15', type: 'REMARKS', title: 'Cancellation note', fileName: 'cancelled-trp-051.txt', fileUrl: '/docs/cancelled-trp-051.txt', createdAt: '2026-05-18T10:00:00Z', note: 'User rejected booking during POD pending stage' },
    ],
    timeline: [
      { id: 'tt-13', title: 'Cancelled', description: 'Booking rejected by user while POD remained pending', timestamp: '2026-05-18T10:00:00Z', status: 'CANCELLED' },
    ],
...
export const MOCK_INVOICES: Invoice[] = [
  {
    ...
    subtotal: 100000, gstAmount: 0, grandTotal: 100000, pdfUrl: '/invoices/INV-2026-001.pdf', tripReferences: ['TRP-040', 'TRP-041'], createdAt: '2026-04-15T12:00:00Z',
  },
  {
    ...
    subtotal: 100000, gstAmount: 0, grandTotal: 100000, pdfUrl: '/invoices/INV-2026-002.pdf', tripReferences: ['TRP-042'], createdAt: '2026-05-13T10:00:00Z',
  },
  {
    ...
    subtotal: 85000, gstAmount: 0, grandTotal: 85000, pdfUrl: '/invoices/INV-2026-003.pdf', tripReferences: ['TRP-046'], createdAt: '2026-05-17T10:00:00Z',
  },
  {
    ...
    subtotal: 92000, gstAmount: 0, grandTotal: 92000, pdfUrl: '/invoices/INV-2026-004.pdf', tripReferences: ['TRP-047'], createdAt: '2026-05-18T10:00:00Z',
  }
]
...
export const MOCK_LEDGER: LedgerEntry[] = [
  ...
  { id: 'led-002', date: '2026-04-20', entryType: 'PAYMENT_RECEIVED', description: 'Partial payment for INV-2026-001', debit: 0, credit: 40000, runningBalance: 60000 },
  { id: 'led-003', date: '2026-05-10', entryType: 'PAYMENT_RECEIVED', description: 'Final payment for INV-2026-001', debit: 0, credit: 58000, runningBalance: 2000 },
  ...
  { id: 'led-007', date: '2026-05-15', entryType: 'RESIDUAL_PAYMENT_RECEIVED', description: 'Residual payment received from escrow account for INV-2026-002', debit: 0, credit: 6000, runningBalance: 2000 },
