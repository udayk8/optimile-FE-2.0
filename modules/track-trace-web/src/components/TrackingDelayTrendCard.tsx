    ...
    <Card className="p-5 sm:p-6">
      ...
      {loading ? (
        ...
        <TrackingAnalyticsEmptyState
          title="No delay trend available"
          description="Delay trend points will appear here once the analytics layer has recent time-bucketed delay history to display."
        />
      ) : (
