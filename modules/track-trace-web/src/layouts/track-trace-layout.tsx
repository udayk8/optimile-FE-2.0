    ...
    items: [
      {
        to: '/trips',
        label: 'Active Trips',
        description: 'Search, filter, and open trip-level tracking details',
        icon: Route,
        page: 'shipments',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Driver scorecards for compliance, idle, overspeed, and trip discipline',
        icon: Gauge,
        page: 'driver-behavior',
        feature: 'tracking.driverBehavior',
      },
    ],
  },
]
...
const pageMeta: Record<TrackTracePageKey, { label: string; description: string }> = {
  ...
  'driver-behavior': { label: 'Driver Behavior', description: 'Driver scorecards across on-time performance, overspeed, idle, and GPS compliance.' },
          ...
          {sidebarExpanded ? (
            <>
              ...
              <div className="min-w-0">
                ...
                <h1 className="text-lg font-extrabold text-text">Track and Trace</h1>
              </div>
            </>
          ) : null}
          <button
