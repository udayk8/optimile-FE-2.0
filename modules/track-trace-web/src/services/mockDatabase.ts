...
const SEED_TRACKING_DEVICES: VehicleTrackingDevice[] = [
    ...
    // BK-2026-1002 (vehicle v3): SIM-based fallback alongside the primary GPS
    // (trk-v3). Mirrors the trip's GPS→SIM fallback scenario.
    {
        tracker_id: 'trk-v3-sim',
        vehicle_id: 'v3',
        device_kind: TrackerDeviceKind.SIM_TRACKING,
        is_primary: false,
        manufacturer: 'Airtel IoT',
        model: 'SIM Cell-ID Locator',
        serial_number: 'SIM-LOC-v3-001',
        imei: 'SIM-V3-001',
        sim_iccid: '8991101200003209983',
        mobile_number: '+919910001133',
        protocol: TrackerProtocol.OTHER,
        install_date: '2024-02-10',
        installer_vendor: 'Airtel IoT Services',
        mounting_location: 'Driver SIM',
        power_source: TrackerPowerSource.BATTERY_PACK,
        ignition_wired: false,
        odometer_at_install: 18200,
        server_host: 'track.optimile.in',
    ...
    // ── Varied tracking-device combinations across trips (demo coverage) ──────
    // BK-2026-1004 (vehicle v5): GPS + SIM + App — full triple-source setup.
    {
        tracker_id: 'trk-v5-gps',
        vehicle_id: 'v5',
        device_kind: TrackerDeviceKind.GPS_TRACKING,
        is_primary: true,
        manufacturer: 'Teltonika',
        model: 'FMB920',
        serial_number: 'TLT-FMB920-005012',
        imei: '356307045012001',
        sim_iccid: '8991101200003205012',
        mobile_number: '+919800050121',
        protocol: TrackerProtocol.TELTONIKA,
        ...
        timezone: 'Asia/Kolkata',
        status: TrackerStatus.ACTIVE,
        last_ping: new Date(Date.now() - 40000).toISOString(),
    },
    {
        tracker_id: 'trk-v5-sim',
        vehicle_id: 'v5',
        device_kind: TrackerDeviceKind.SIM_TRACKING,
        is_primary: false,
        manufacturer: 'Vi IoT',
        model: 'SIM Cell-ID Locator',
        serial_number: 'SIM-LOC-v5-001',
        imei: 'SIM-V5-001',
        sim_iccid: '8991101200003205013',
        mobile_number: '+919800050122',
        protocol: TrackerProtocol.OTHER,
        install_date: '2024-02-28',
        installer_vendor: 'Vi IoT Services',
        mounting_location: 'Driver SIM',
        power_source: TrackerPowerSource.BATTERY_PACK,
        ignition_wired: false,
        odometer_at_install: 22500,
    ...
    {
        tracker_id: 'trk-v5-app',
        vehicle_id: 'v5',
        device_kind: TrackerDeviceKind.DRIVER_APP,
        is_primary: false,
        manufacturer: 'Optimile',
        model: 'Driver App',
        serial_number: 'DRV-APP-v5-d1',
        imei: 'APP-V5-D1',
        mobile_number: '+919800050123',
        protocol: TrackerProtocol.OTHER,
    ...
    // BK-2026-1006 (vehicle v6): dual GPS — primary + secondary hardware units.
    {
        tracker_id: 'trk-v6-gps-primary',
        vehicle_id: 'v6',
        device_kind: TrackerDeviceKind.GPS_TRACKING,
        is_primary: true,
        manufacturer: 'Queclink',
        model: 'GV300W',
        serial_number: 'QUE-GV300W-006001',
        imei: '868683046006001',
        sim_iccid: '8991101200003206001',
        mobile_number: '+919800060011',
        protocol: TrackerProtocol.QUECLINK,
        install_date: '2024-01-20',
        installer_vendor: 'North Fleet Systems',
        mounting_location: 'Cabin Console',
        power_source: TrackerPowerSource.DIRECT,
        ignition_wired: true,
        odometer_at_install: 35000,
        server_host: 'track.optimile.in',
        server_port: '5027',
        apn: 'jionet',
        reporting_interval_sec: 20,
    ...
    {
        tracker_id: 'trk-v6-gps-secondary',
        vehicle_id: 'v6',
        device_kind: TrackerDeviceKind.GPS_TRACKING,
        is_primary: false,
        manufacturer: 'Concox',
        model: 'GT06N',
        serial_number: 'CNX-GT06N-006002',
        imei: '356938036006002',
        sim_iccid: '8991101200003206002',
        mobile_number: '+919800060012',
        protocol: TrackerProtocol.CONCOX,
        install_date: '2024-01-20',
        installer_vendor: 'North Fleet Systems',
        mounting_location: 'Chassis Rail',
        power_source: TrackerPowerSource.OBD,
        ignition_wired: true,
        odometer_at_install: 35000,
        server_host: 'track.optimile.in',
        server_port: '5027',
        ...
        timezone: 'Asia/Kolkata',
        status: TrackerStatus.ACTIVE,
        last_ping: new Date(Date.now() - 75000).toISOString(),
    },

    // BK-2026-1007 (vehicle v7): GPS + Manual fallback (alongside primary trk-v7).
    {
        tracker_id: 'trk-v7-manual',
        vehicle_id: 'v7',
        device_kind: TrackerDeviceKind.MANUAL,
        is_primary: false,
        manufacturer: 'Optimile',
        model: 'Manual Check-in',
        serial_number: 'MAN-v7-001',
        imei: 'MAN-V7-001',
        protocol: TrackerProtocol.OTHER,
        install_date: '2024-03-05',
        installer_vendor: 'Operations Desk',
        mounting_location: 'Control Tower',
        power_source: TrackerPowerSource.BATTERY_PACK,
        ignition_wired: false,
        odometer_at_install: 11890,
        server_host: 'track.optimile.in',
    ...
    // BK-2026-1009 (vehicle v8): SIM + App only — no hardware GPS fitted.
    {
        tracker_id: 'trk-v8-sim',
        vehicle_id: 'v8',
        device_kind: TrackerDeviceKind.SIM_TRACKING,
        is_primary: true,
        manufacturer: 'Airtel IoT',
        model: 'SIM Cell-ID Locator',
        serial_number: 'SIM-LOC-v8-001',
        imei: 'SIM-V8-001',
        sim_iccid: '8991101200003208001',
        mobile_number: '+919800080011',
        protocol: TrackerProtocol.OTHER,
        ...
        timezone: 'Asia/Kolkata',
        status: TrackerStatus.ACTIVE,
        last_ping: new Date(Date.now() - 110000).toISOString(),
    },
    {
        tracker_id: 'trk-v8-app',
        vehicle_id: 'v8',
        device_kind: TrackerDeviceKind.DRIVER_APP,
        is_primary: false,
        manufacturer: 'Optimile',
        model: 'Driver App',
        serial_number: 'DRV-APP-v8-d1',
        imei: 'APP-V8-D1',
        mobile_number: '+919800080012',
        protocol: TrackerProtocol.OTHER,
        install_date: '2024-02-16',
        installer_vendor: 'Self Activated',
        mounting_location: 'Driver Smartphone',
        power_source: TrackerPowerSource.BATTERY_PACK,
        ignition_wired: false,
        ...
        timezone: 'Asia/Kolkata',
        status: TrackerStatus.ACTIVE,
        last_ping: new Date(Date.now() - 260000).toISOString(),
    },

    // BK-2026-1010 (vehicle v10): manual check-ins only — no electronic tracking.
    {
        tracker_id: 'trk-v10-manual',
        vehicle_id: 'v10',
        device_kind: TrackerDeviceKind.MANUAL,
        is_primary: true,
        manufacturer: 'Optimile',
        model: 'Manual Check-in',
        serial_number: 'MAN-v10-001',
        imei: 'MAN-V10-001',
        protocol: TrackerProtocol.OTHER,
        ...
        timezone: 'Asia/Kolkata',
        status: TrackerStatus.ACTIVE,
        last_ping: new Date(Date.now() - 5400000).toISOString(),
    },
];
