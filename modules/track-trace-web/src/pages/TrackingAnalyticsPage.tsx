...
export function TrackingAnalyticsPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .catch(() => {
        if (active) setError('Tracking analytics could not be prepared.')
      })
      .finally(() => {
              ...
              <DataTable
                ...
                emptyState={(
                  <EmptyPlaceholder
                    ...
                    description="No alerts were raised or resolved in the selected date window."
                  />
                )}
            ...
            <div className="mt-4 space-y-3">
              {riskRows.length ? (
                ...
                <EmptyPlaceholder
                  ...
                  description="No trips are currently flagged above the risk threshold."
                />
              )}
            </div>
          </Card>
