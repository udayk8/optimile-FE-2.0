...
export function GeofenceManagementPage() {
  ...
  function openCreateForm() {
    ...
    setShowForm(true)
    setSaveError(null)
    setTimeout(() => document.getElementById('geofence-form')?.scrollIntoView({ behavior: 'smooth', block: 'start' }), 50)
  }
  ...
  async function handleSave() {
    ...
    try {
      ...
      setSaveError(saveFailure instanceof Error ? saveFailure.message : 'Geofence could not be saved.')
    } finally {
      setIsSaving(false)
    }
  }
      ...
      <div className="space-y-6">
        ...
        <Card className={trackTraceV2StickyPanelClassName}>
          <div className="flex flex-wrap items-end gap-4">
            ...
            >
              {showForm && !editing ? 'Cancel creation' : '+ New geofence'}
            </Button>
          </div>
        </Card>
