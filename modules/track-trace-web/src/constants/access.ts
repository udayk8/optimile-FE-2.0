...
export const TRACK_TRACE_ROLE_PAGE_ACCESS: Record<TrackTraceRole, TrackTracePageKey[]> = {
  'control-tower': ['dashboard', 'shipments', 'shipment-detail', 'replay', 'customer-preview', 'analytics', 'route-performance', 'vehicles', 'vehicle-detail', 'live-map', 'route-progress', 'exceptions', 'alerts', 'pod', 'control-tower', 'geofences', 'dispatch'],
  'tenant-admin': ['dashboard', 'shipments', 'shipment-detail', 'replay', 'customer-preview', 'analytics', 'route-performance', 'vehicles', 'vehicle-detail', 'live-map', 'route-progress', 'exceptions', 'alerts', 'pod', 'control-tower', 'geofences', 'dispatch'],
  'platform-admin': ['dashboard', 'shipments', 'shipment-detail', 'replay', 'customer-preview', 'analytics', 'route-performance', 'vehicles', 'vehicle-detail', 'live-map', 'route-progress', 'exceptions', 'alerts', 'pod', 'control-tower', 'geofences', 'dispatch'],
  'fleet-operator': ['dashboard', 'shipments', 'shipment-detail', 'replay', 'analytics', 'route-performance', 'vehicles', 'vehicle-detail', 'live-map', 'route-progress', 'exceptions', 'alerts', 'control-tower', 'geofences', 'dispatch'],
