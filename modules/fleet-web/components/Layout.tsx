...
export const Layout: React.FC<LayoutProps> = ({ children, activeTab, onNavigate, notifications = [] }) => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      {/* ── Main content area ──────────────────────────────────────────── */}
      <div className="flex min-h-0 w-0 flex-1 flex-col overflow-hidden pt-14 md:pt-0">
        ...
        <main className="scrollbar-hide relative min-h-0 flex-1 overflow-y-auto focus:outline-none">
          <div className="py-6">
