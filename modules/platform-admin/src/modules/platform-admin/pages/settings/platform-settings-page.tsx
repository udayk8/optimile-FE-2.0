    ...
    <div className="space-y-6">
      ...
      >
        <div className="grid gap-4 md:grid-cols-2">
          ...
          />
          <div className="rounded-xl border border-warning/20 bg-warning/10 px-4 py-4 text-sm leading-6 text-warning">
...
function SettingToggle({
  ...
  return (
    <div className="flex items-start justify-between gap-4 rounded-xl border border-gray-200 bg-gray-50 px-4 py-4">
      <div>
