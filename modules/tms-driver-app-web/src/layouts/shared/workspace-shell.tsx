        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="app-shell-gradient sticky top-0 z-30 flex items-center justify-between gap-4 border-b border-border/70 px-4 py-3.5 xl:px-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                aria-label="Sign out"
                className="flex h-10 w-10 items-center justify-center rounded-lg border border-border/80 text-muted-foreground transition hover:bg-accent hover:text-foreground"
