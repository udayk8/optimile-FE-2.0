...
const tenantReportTemplates: ReportTemplateDefinition[] = [
  {
    ...
    description:
      'Executive booking summary with fast KPI cards, monthly trends, and operational status rollups.',
  ...
  },
  {
    ...
    description:
      'Specialized report for rate approvals, assignment blockers, and detail-heavy operational investigation.',
    defaultMetric: 'booking_count',
