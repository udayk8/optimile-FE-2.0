...
import { TenantEmptyState, TenantPanel } from "@tms-booking/modules/tenant-admin/components/tenant-primitives";
            ...
            {bookingLrs.map((record) => (
              <div key={record.id} className="rounded-2xl border border-border/70 bg-white p-4">
                ...
                <Button asChild variant="outline" size="sm" className="mt-3">
                  <Link to={paths.tenantLrWorkspace}>View LR Register</Link>
                </Button>
              </div>
            ))}
          </div>
