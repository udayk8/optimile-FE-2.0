...
import { resolveManualLrFormatForOrgUnit } from "@tms-booking/modules/tenant-admin/lib/manual-lr";
...
function isEnterpriseTenantTarget(tenant: Pick<TenantRecord, "id" | "code">) {
  return tenant.id === ENTERPRISE_TENANT_ID || tenant.code.trim().toUpperCase() === ENTERPRISE_TENANT_CODE;
}
...
function buildEnterpriseTenantEl001Access(params: {
  ...
  const nextTenant = {
    ...
    enabledModuleCodes: Array.from(new Set([...tenant.enabledModuleCodes, "TMS", "FLEET", "PROCUREMENT", "FINANCE"])),
