...
export const mockTenantBookings: BookingRecord[] = [
  ...
  {
    id: "booking-erp-1",
    bookingId: "BKG-ERP-2026-0001",
    tenantId: "tenant-northstar",
    bookingSource: "ERP" as const,
    erpReference: {
      erpReferenceNumber: "ERP-SO-10001",
      salesOrderNumber: "SO-10001",
      externalBookingNumber: null,
      integrationStatus: "MOCK" as const,
    },
    customerId: "tenant-customer-1",
    materialIds: ["material-1"],
    sourceAddressId: "customer-address-1",
    ...
    remarks: [
      {
        id: "booking-erp-1-remark-1",
        timestamp: "2026-04-22T07:00:00Z",
        actor: "ERP System",
        type: "OPS_REMARK",
        message: "Booking imported from ERP sales order SO-10001.",
      },
    ],
    statusTimeline: [
      { id: "booking-erp-1-status-1", status: "DRAFT", timestamp: "2026-04-22T07:00:00Z", actor: "ERP System" },
      { id: "booking-erp-1-status-2", status: "PENDING_ASSIGNMENT", timestamp: "2026-04-22T07:01:00Z", actor: "System", note: "ERP booking ready for assignment." },
    ],
    createdAt: "2026-04-22T07:00:00Z",
    updatedAt: "2026-04-22T07:01:00Z",
