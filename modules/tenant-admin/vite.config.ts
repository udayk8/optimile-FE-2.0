...
export default defineConfig({
  ...
  resolve: {
    alias: {
      '@/shared/components/common': path.resolve(__dirname, '../platform-admin/src/components/common'),
      '@/shared/components/ui': path.resolve(__dirname, '../platform-admin/src/components/ui'),
      '@/shared/auth': path.resolve(__dirname, '../platform-admin/src/shared/auth'),
