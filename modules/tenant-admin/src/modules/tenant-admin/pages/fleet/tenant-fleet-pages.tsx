...
import { useTenantDrivers, useTenantVehicles } from "../../hooks/useTenantFleet";
...
export function TenantDriversPage() {
  ...
  function submitDriver() {
    ...
    if (!form.assignedVehicleId) {
      setError("Assigned vehicle is required.");
      return;
    }
    if (selectedVehicle && (selectedVehicle.vendorId ?? null) !== (form.vendorId ?? null)) {
      setError("Driver ownership must match the selected vehicle.");
      return;
    }
    ...
    <div className="space-y-6">
      ...
      {filteredDrivers.length ? (
        ...
        <TenantEmptyState
          ...
          description="Add the first driver to enable clean vehicle-driver assignment in booking operations."
      ...
      <Dialog
        ...
        description="Driver affiliation must match the selected vehicle ownership."
        widthClassName="max-w-5xl"
        footer={
          <div className="flex justify-end gap-3">
            <Button variant="outline" onClick={() => setOpen(false)}>
            ...
            <div className="grid gap-4 md:grid-cols-3">
                ...
                <Select
                  ...
                  onChange={(event) => {
                    ...
                    setForm((current) => ({
                      ...
                      vendorId: vehicle?.ownershipType === "VENDOR" ? vehicle.vendorId ?? null : null,
                    }));
                  }}
                >
              ...
              <Field label="Vendor Affiliation">
                <Select
                  ...
                  disabled={selectedVehicle?.ownershipType === "VENDOR"}
                >
