...
} from "@constants/module-access";
export { MODULE_CODE_TO_KEY, hierarchyLabelSuggestions };
...
export function getUserTypeHelper(userType: UserType) {
  switch (userType) {
    ...
    case "CUSTOMER":
      return "Customer portal users stay restricted to their linked customer bookings, invoices, LR, POD, and related documents.";
    default:
      return "";
  }
}
