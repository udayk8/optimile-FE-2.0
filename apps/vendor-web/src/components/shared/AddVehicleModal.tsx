        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-4">
          <div className="space-y-2">
            ...
            <Input 
              ...
              className={touched.registration && errors.registration ? 'border-destructive focus-visible:ring-destructive' : ''}
            />
            {touched.registration && errors.registration && (
              <p className="text-xs text-destructive">{errors.registration}</p>
            )}
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input 
              ...
              className={touched.baseLocation && errors.baseLocation ? 'border-destructive focus-visible:ring-destructive' : ''}
            />
            {touched.baseLocation && errors.baseLocation && (
              <p className="text-xs text-destructive">{errors.baseLocation}</p>
            )}
          </div>
          <DialogFooter>
