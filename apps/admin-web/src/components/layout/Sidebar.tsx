...
const NAV_ITEMS = [
  { path: '/admin/auction/dashboard', label: 'Dashboard', subtitle: 'Operational overview', icon: LayoutDashboard, module: 'dashboard' },
  { path: '/admin/auction/auctions', label: 'Auctions', subtitle: 'Create, monitor, award', icon: Gavel, module: 'auction' },
  { path: '/admin/auction/contracts', label: 'Contracts', subtitle: 'Award outputs and status', icon: FileText, module: 'contracts' },
] as const
