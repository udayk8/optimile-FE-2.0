...
import { isBookingDelayCandidate } from "@/modules/tms/booking/services/booking-engine";
import {
  buildAddressLookup,
  buildCustomerLookup,
  buildDriverLookup,
  ...
  return (
    <div className="space-y-4">
      ...
      <DataTable
        ...
        onRowClick={(rowIndex) => navigate(`/tenant/${tenant.id}/bookings/${completedBookings[rowIndex].id}`)}
