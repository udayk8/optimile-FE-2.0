                      ...
                      <td className="px-4 py-4 align-top">
                        <div className="flex min-w-[220px] flex-wrap gap-2">
                          <Button asChild size="sm" variant="ghost">
                            <Link to={`/platform/tenants/${tenant.id}`}>View details</Link>
                          </Button>
                          <Button
                            size="sm"
                            variant="outline"
        ...
        <div className="space-y-5">
          ...
          {step === 1 ? (
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="md:col-span-2 rounded-2xl border bg-background/80 p-4">
          ...
          {step === 4 && createdTenant ? (
            <div className="space-y-5">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Button asChild variant="outline">
                  <Link to={`/platform/tenants/${createdTenant.id}`}>Review tenant detail</Link>
                </Button>
                <Button
                  variant="ghost"
                  onClick={() => {
